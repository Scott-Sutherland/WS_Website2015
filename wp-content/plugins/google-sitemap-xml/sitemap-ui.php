			...
			<form method="post" action="<?php echo $this->sg->GetBackLink() ?>">
				...
				?>
					...
					<?php if(!$snl): ?>
							...
							<?php $this->HtmlPrintBoxHeader('dm_donations',__('Donate:','sitemap'),true); ?>
					...
					<?php
						...
						<div style="min-height:150px;">
							...
							<ul>
								<li>
									<?php echo sprintf(__('If you like the plugin, please <a target="_blank" href="%s">rate it 5 stars</a> or <a href="%s">donate</a> via PayPal! Thanks a lot! :)','sitemap'),$this->sg->GetRedirectLink('sitemap-works-note'),$this->sg->GetRedirectLink('sitemap-paypal')); ?>
								</li>
